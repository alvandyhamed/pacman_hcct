import { Easy_LEVEL, Medium_LEVEL, hard_LEVEL, OBJECT_TYPE } from "./setup";
...
var selectedValue = Easy_LEVEL;
let gameBoard = GameBoard.createGameBoard(gameGrid, selectedValue);
...
window.addEventListener("load", function () {
  ...
  document.getElementById("myComboBox").addEventListener("change", function () {
    ...
    gameBoard = GameBoard.createGameBoard(gameGrid, selectedValue);
